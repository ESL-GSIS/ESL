...
namespace ESL.Controllers
{
    public class AdvisorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstName,Phone")] Advisor advisor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstName,Phone")] Advisor advisor)
        {
            if (ModelState.IsValid)
            {
